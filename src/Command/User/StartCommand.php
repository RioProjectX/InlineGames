...
class StartCommand extends UserCommand
{
    ...
    public function execute(): ServerResponse
    {
        ...
        $text .= '<b>' . __('Halo! Saya InlinesGame Bot. Made By @fckualot') . '</b>' . PHP_EOL;
        $text .= __('Untuk Bermain, Mulai Sebuah Pesan Dengan {USAGE} Didalam Group Chat Kamu Atau Klik Tombol {BUTTON} dan berikutnya pilih group chat untuk bermain.', ['{USAGE}' => '<b>\'@' . $this->getTelegram()->getBotUsername() . ' ...\'</b>', '{BUTTON}' => '<b>\'' . __('Play') . '\'</b>']);
